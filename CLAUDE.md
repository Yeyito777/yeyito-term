...
| **notification**, notify, popup, `_ST_NOTIFY`, notification internals | `reference/notifications.md` |
| **st-notify**, st-notify usage, st-notify options, send notification | `reference/st-notify.md` |
