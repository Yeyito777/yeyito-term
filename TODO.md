...
- [ ] You cannot enter normal mode or nav mode when you're in a stdout stream or TUI because zsh never sends the code. Make sure we can still enter normal mode if we're in a stdout stream or TUI and sync back with zsh when it ends or is closed
