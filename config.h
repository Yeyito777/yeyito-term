...
static const char *colorname[] = {
	...
	/* 8 bright colors */
	"#1d3557", /* bright black → slatey deep blue */
	"#ff8787", /* bright red   → soft coral */
	"#4ddbb7", /* bright green → tropical teal */
	"#ffe066", /* bright yellow→ golden reflection */
	"#5fa8d3", /* bright blue  → shallow wave */
	"#c77dff", /* bright magenta → lavender tide */
	"#48cae4", /* bright cyan  → lagoon aqua */
	"#f1faee", /* bright white → foamy white */

	[255] = 0,

	/* extra colors (fg/bg/cursor) */
	"#f1faee", /* 256 → default foreground (foam white) */
	"#00050f", /* 257 → default background (abyss black) */
...
static Shortcut shortcuts[] = {
	...
	{ ControlMask,          XK_p,           zoomreset,      {.f =  0} },
...
/* SSH indicator configuration is now in sshind.h */
